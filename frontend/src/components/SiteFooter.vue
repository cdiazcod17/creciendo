<template>
  <footer class="mt-10 border-t border-forest/10 bg-white/40">
    <div class="mx-auto grid max-w-6xl gap-8 px-4 py-8 sm:px-6 lg:grid-cols-[1.1fr_0.9fr_0.9fr] lg:px-8 lg:py-10">
      <div>
        <AppLogo />
