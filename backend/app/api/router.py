...
from app.api.routes import health_notes
...
api_router.include_router(growth_record.router,prefix="/babies/{baby_id}/growth-records", tags=["growth-records"])
api_router.include_router(appointment.router,prefix="/babies/{baby_id}/appointments", tags=["appointments"])
api_router.include_router(health_notes.router,prefix="/babies/{baby_id}/health-notes", tags=["health-notes"])